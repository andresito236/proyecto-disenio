<nav id="sidebar" class="d-flex flex-column flex-shrink-0 p-4 d-none d-sm-flex col-sm-4 col-md-3 col-lg-2 gap-3">
    ...
    <ul id="lista" class="nav nav-pills flex-column mb-auto gap-1">
        ...
        <li>
            <a href="#submenuIngresos"  class="nav-link text-change" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="submenuIngresos">
        ...
        <li>
            <a href="#submenuEgresos" class="nav-link text-change" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="submenuEgresos">
            <i class="fi fi-rr-coins me-2"></i>
                Egresos
            </a>
        ...
        <li>
            <a href="#" class="nav-link text-change">
            <i class="fi fi-rr-coins me-2"></i>
                Relleno
            </a>
        </li>
